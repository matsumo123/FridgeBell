...
ActiveRecord::Schema[7.2].define(version: 2025_10_08_050155) do
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["stage_number"], name: "index_characters_on_stage_number", unique: true
  end
  ...
  create_table "user_characters", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_user_characters_on_user_id", unique: true
  end
  ...
  add_foreign_key "food_actions", "user_foods"
