...
vegetables = [
  ...
  { name: "かぼちゃ", quantity: 0.25, unit: "個", default_deadline: 8, file: "野菜類_かぼちゃ.png" },
  ...
  { name: "キャベツ", quantity: 0.25, unit: "個", default_deadline: 7, file: "野菜類_キャベツ.png" },
  { name: "白菜", quantity: 0.25, unit: "個", default_deadline: 7, file: "野菜類_はくさい.png" },
...
fruits = [
  ...
  { name: "スイカ", quantity: 0.25, unit: "カット", default_deadline: 3, file: "果実類_スイカ.png" },
